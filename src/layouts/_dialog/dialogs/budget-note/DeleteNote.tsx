...
// hooks
// import { useGetNoteWithBudget } from "@/lib/react-query/queries" // FIXME: implement query
...
const DeleteNote = () => {
  ...
  // const { data: note, isLoading } = useGetNoteWithBudget(budgetId, id) // FIXME: implement query
